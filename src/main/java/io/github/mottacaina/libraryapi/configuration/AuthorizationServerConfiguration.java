...
import io.github.mottacaina.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                ...
                .tokenIntrospectionEndpoint("/oauth2/instrspect")
        ...
        return context -> {
            ...
            if(principal instanceof CustomAuthentication authentication){
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tipoToken)){
                    ...
                    List<String> authoritiesList = authorities.stream().map(
                    ...
                    context
                            ...
                            .claim("authorities", authentication.getUsuario().getEmail());
